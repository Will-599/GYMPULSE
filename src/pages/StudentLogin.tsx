...
import { Mail, Lock, ArrowRight, Dumbbell, Hash, ArrowLeft } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-8 xl:p-12 overflow-hidden border-r border-brand-border/30">
        ...
        >
          ...
          <p className="text-lg xl:text-xl text-brand-muted font-light leading-relaxed mb-8">
            Acesse seus treinos e acompanhe sua evolução de qualquer lugar.
          </p>
          ...
          <div className="space-y-4 text-brand-text/80 text-sm xl:text-base">
            <div className="flex items-center gap-3">
              ...
              <span>Utilize seu e-mail e senha cadastrados</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 relative">
        ...
        >
          <div className="mb-6 xl:mb-8">
            ...
            <p className="text-brand-muted text-sm xl:text-base">Acesse sua conta de aluno</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-brand-muted">
            Ainda não tem conta?{' '}
            <Link to="/student/register" className="text-brand-green hover:underline font-medium">
              Cadastrar-se
            </Link>
          </p>
        </motion.div>
